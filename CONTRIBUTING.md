Contributing to Expedia Core
============================

The Expedia Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Expedia Core project, and is not to be
confused with overall Expedia Network Protocol consensus changes.

Whether a pull request is merged into Expedia Core rests with the project merge
...
Patches that change Expedia consensus rules are considerably more involved than
...
Where a patch set proposes to change the Expedia consensus, it must have been
...
The project leader is the release manager for each Expedia Core release.
