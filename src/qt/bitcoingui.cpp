                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Expedia Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Expedia address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and expedia: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zEXP"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Expedia Core"), this);
    aboutAction->setStatusTip(tr("Show information about Expedia Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Expedia"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Expedia addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Expedia addresses"));
    ...
    openAction->setStatusTip(tr("Open a Expedia: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Expedia Core help message to get a list with possible Expedia command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Expedia Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Expedia network", "", count));
}
...
{
    QString strTitle = tr("Expedia Core"); // default title
