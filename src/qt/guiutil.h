...
/** Utility functions used by the Expedia Qt UI.
 */
namespace GUIUtil
{
...
// Render Expedia addresses in monospace font
...
// Parse "expedia:" URI into recipient object, return true on successful parsing
