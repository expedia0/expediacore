...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Expedia server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Expedia features */
        {"expedia", "masternode", &masternode, true, true, false},
        {"expedia", "listmasternodes", &listmasternodes, true, true, false},
        {"expedia", "getmasternodecount", &getmasternodecount, true, true, false},
        {"expedia", "masternodeconnect", &masternodeconnect, true, true, false},
        {"expedia", "masternodecurrent", &masternodecurrent, true, true, false},
        {"expedia", "masternodedebug", &masternodedebug, true, true, false},
        {"expedia", "startmasternode", &startmasternode, true, true, false},
        {"expedia", "createmasternodekey", &createmasternodekey, true, true, false},
        {"expedia", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"expedia", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"expedia", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"expedia", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"expedia", "getmasternodescores", &getmasternodescores, true, true, false},
        {"expedia", "mnbudget", &mnbudget, true, true, false},
        {"expedia", "preparebudget", &preparebudget, true, true, false},
        {"expedia", "submitbudget", &submitbudget, true, true, false},
        {"expedia", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"expedia", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"expedia", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"expedia", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"expedia", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"expedia", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"expedia", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"expedia", "checkbudgets", &checkbudgets, true, true, false},
        {"expedia", "mnsync", &mnsync, true, true, false},
        {"expedia", "spork", &spork, true, true, false},
        {"expedia", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"expedia", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use expediad, or the -server option to expedia-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> expedia-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1: 2181/\n";
}
