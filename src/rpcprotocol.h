...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Expedia is not connected
    ...
    RPC_WALLET_PASSEXPASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
