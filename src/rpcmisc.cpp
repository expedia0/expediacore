...
// Copyright (c) 2017-2018 The Expedia developers
...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total expedia balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zEXPsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zEXP denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zEXP denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zEXP denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zEXP denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zEXP denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zEXP denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zEXP denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zEXP denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zEXP denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in expedia/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in expedia/kb\n"
    ...
    obj.emplace_back(Pair("zEXPsupply", zcivObj));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"expediaaddress\"\n"
            "\nReturn information about the given expedia address.\n"
            "\nArguments:\n"
            "1. \"expediaaddress\"     (string, required) The expedia address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"expediaaddress\", (string) The expedia address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Expedia address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are expedia addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) expedia address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"expediaaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"expediaaddress\"  (string, required) The expedia address to use for the signature.\n"
