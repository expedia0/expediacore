...
/** 
    ...
    ****Note - for Expedia we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of expedia coming in to a transaction
