...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Expedia Core expedia-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  expedia-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded expedia transaction") + "\n" +
                               "  expedia-tx [options] -create [commands]   " + _("Create hex-encoded expedia transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded expedia transaction
