...
RESOURCES += src/qt/expedia.qrc src/qt/expedia_locale.qrc

TRANSLATIONS += src/qt/locale/expedia_bg.ts \
                src/qt/locale/expedia_de.ts \
                src/qt/locale/expedia_en.ts \
                src/qt/locale/expedia_es.ts \
                src/qt/locale/expedia_fi.ts \
                src/qt/locale/expedia_fr.ts \
                src/qt/locale/expedia_it.ts \
                src/qt/locale/expedia_ja.ts \
                src/qt/locale/expedia_pl.ts \
                src/qt/locale/expedia_pt.ts \
                src/qt/locale/expedia_ru.ts \
                src/qt/locale/expedia_sk.ts \
                src/qt/locale/expedia_sv.ts \
                src/qt/locale/expedia_vi.ts \
                src/qt/locale/expedia_zh_CN.ts \
                src/qt/locale/expedia_zh_TW.ts
