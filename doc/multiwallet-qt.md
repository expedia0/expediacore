...
In order to support loading of multiple wallets in expedia-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is expedia.cpp.
...
Changes to expedia.cpp
----------------------
expedia.cpp is the entry point into expedia-qt, and as such, will require some minor modifications to provide hooks for
